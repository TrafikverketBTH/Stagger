...
public class Token {
    ...
    public final static int TOK_DASH        = 5;
    public final static int TOK_SYMBOL      = 6;
    public final static int TOK_NUMBER      = 7;
    public final static int TOK_EMAIL       = 8;
    public final static int TOK_URL         = 9;
    public final static int TOK_SMILEY      = 10;
    public final static int TOK_SENT_FINAL  = 11;
    public final static int TOK_LATIN       = 12;
    public final static int TOK_GREEK       = 13;
    public final static int TOK_ARABIC      = 14;
    public final static int TOK_HANZI       = 15;
